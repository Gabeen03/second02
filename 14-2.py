...
plt savefig("C:\Users\kgblo\source\repos\second02")
...
# 해당일 기준 증가 상승율 상대 수익 계산
d = (dow.Close / dow.Close.loc["2010-05-01"]) * 100
k = (kospi.Close / kospi.Close.loc["2010-05-01"]) * 100
...
df = pd.cmcat(df_list,ignore_index = True)
